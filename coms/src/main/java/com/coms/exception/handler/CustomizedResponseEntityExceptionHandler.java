 ...
 */
package com.coms.exception.handler;
...
import com.coms.exception.model.ApiError;
import com.coms.exception.model.ExceptionResponse;
...
public class CustomizedResponseEntityExceptionHandler
    ...
    public final ResponseEntity<ExceptionResponse> handleSecurityErrorException(
            SecurityErrorException exception,
            WebRequest webRequest) {
        logger.error("SecurityErrorException: {}", exception);
    ...
    public final ResponseEntity<Object>
            handleIncorrectResultSizeDataAccessException(
    ...
    public final ResponseEntity<ExceptionResponse> handleSQLException(
