...
@DynamicInsert
@DynamicUpdate
public class BookSetItem implements Serializable {
    ...
    public void setSetItemId(Long setItemId) {
    ...
    public String toString() {
        return "BookSetItem{" + "setItemId=" + setItemId + ", title=" + title + ", shortTitle=" + shortTitle
